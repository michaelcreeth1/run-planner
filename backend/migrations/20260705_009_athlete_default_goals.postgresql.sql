...
SELECT gen_random_uuid()::text, a.id, NULL, 'recovery', 'achievement', 'Preserve at least 1 rest day',
...
SELECT gen_random_uuid()::text, a.id, NULL, 'long_run', 'guardrail', 'Long run no more than 30% of week',
...
SELECT gen_random_uuid()::text, a.id, NULL, 'quality', 'guardrail', 'No more than 2 hard days',
