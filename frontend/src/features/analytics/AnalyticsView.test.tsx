...
const analytics: AnalyticsPlanning = {
  ...
  weeks: [
    { weekStartDate: "2026-07-06", weekEndDate: "2026-07-12", weekState: "past", plannedMileage: 20, actualMileage: 18, comparisonMileage: 18, hardDays: 1, actualHardDays: 1, restDays: 2, actualRestDays: 2, hasBackToBackHardDays: false, longRunDistance: 8, longRunPercentage: 0.44, loadRisk: "clear", longRunRisk: "clear", intensityRisk: "clear", recoveryRisk: "clear", hasPlan: true, hasActuals: true },
    { weekStartDate: "2026-07-13", weekEndDate: "2026-07-19", weekState: "current", plannedMileage: 22, actualMileage: 0, comparisonMileage: 22, hardDays: 1, actualHardDays: 0, restDays: 2, actualRestDays: 0, hasBackToBackHardDays: false, longRunDistance: 9, longRunPercentage: 0.41, loadRisk: "clear", longRunRisk: "clear", intensityRisk: "clear", recoveryRisk: "clear", hasPlan: true, hasActuals: false }
  ],
  goalReliability: []
};
